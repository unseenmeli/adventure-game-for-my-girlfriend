...
const Notebook = ({ isOpen, onClose }: NotebookProps) => {
  ...
  // You can customize this content with your own messages
  const leftPageContent = `Dear Shmariam,

Every moment with you feels like magic. 
From our first date to all the little 
moments in between, you've made my 
life brighter.
...
or sit in comfortable silence ( kidev... ).`;

  const rightPageContent = (
    <div>
      <div className="mb-4">Our adventures together:</div>
      
      <div className="mb-3">• Our first date - nervous but perfect</div>
      <div className="mb-3">Unforunately I do not have a picture of our first date but yeah!</div>
      
      <div className="mb-3">• Our second date - first kiss... {'>'}:)</div>
      ...
      <div>To advance to the next stage... at the door write my cars' model. ( ar vicodi ra mekitxa )</div>
    </div>
  );
